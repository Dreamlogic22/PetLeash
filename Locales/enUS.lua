...
local L = LibStub("AceLocale-3.0"):NewLocale("PetLeash", "enUS", true)
...
L["Enabled"] = true
L["EXPLAIN_SPECIAL_ITEMS"] = "Certain items act like a companion pet when used, but the UI does not indicate that a companion pet is currently being used.  PetLeash can temporarily deactivate when such an item is detected."
L["EXPLAIN_WEIGHTED_CHECKBOX"] = "Right-click on the checkbox to enable with a different weight."
L["Extra High Priority"] = true
L["Extra Low Priority"] = true
L["Filters"] = true
L["High Priority"] = true
L["How long must pass before a player is considered idle enough to summon a pet."] = true
L["Immediate"] = true
L["Instance"] = true
L["Left-Click:"] = true
L["Low Priority"] = true
...
L["Rename to"] = true
L["Reset"] = true
L["Resummon pet after a pet has been summoned via setting the battle pet loadout."] = true
L["Right-Click:"] = true
