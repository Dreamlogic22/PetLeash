...
local options_slashcmd = {
    ...
    args = {
        ...
        resummon = {
            ...
            order = 20,
            func = function() addon:ResummonPet(true, true) end
        },
        dismiss = {
            type = "execute",
            name = L["Dismiss Pet"],
            ...
            order = 21,
            func = function() addon:DismissPet(true) end
        },
        desummon = {
        ...
        togglePet = {
            ...
            order = 22,
            func = function() addon:TogglePet() end
        },
        ...
        debugstate = {
            ...
            name = "Debug State",
            hidden = true,
            func = function() addon:DumpDebugState() end
        }
    },
}
    ...
    do
        ...
        do
            ...
            function selectTab_Fill(frame, set)
                ...
                local selector = AceGUI:Create("PetLeash_PetSelectList")
